...
-- 	maxDistance = 2.0,
-- 	fixText = false,
-- 	authorizedJobs = { ['cityhall']=0,['lawyer']=0 ,['police']=0,['bcso']=0,['sasp']=0 },
-- 	slides = false,
-- 	objHash = 660342567,		
-- 	-- oldMethod = true,
...
table.insert(Config.DoorList, {
	...
	authorizedCitizenIDs = { ['XQD60195'] = true, ['AGN68062'] = true },
	slides = false,
	objHash = 1762042010,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	fixText = false,
	authorizedJobs = { ['cityhall']=0,['lawyer']=10 ,['police']=0,['bcso']=0,['sasp']=0 },
	slides = false,
	objHash = 1762042010,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
