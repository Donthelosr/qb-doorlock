...
table.insert(Config.DoorList, {
	...
	authorizedJobs = { ['ambulance']=0, ['sasp']=0, ['police']=0, ['sasp']=0, ['police']=0 },
	locked = false,
	garage = false,
	maxDistance = 2.0,
	audioRemote = false,
...
table.insert(Config.DoorList, {
	...
	slides = false,
	objHash = 854291622, -- gabz_pillbox_singledoor
	authorizedJobs = { ['ambulance']=0, ['sasp']=0, ['police']=0 },
	locked = false,
	garage = false,
	maxDistance = 2.0,
	audioRemote = false,
...
-- warda created by don
Config.DoorList['pillbox-warda'] = {
    doorRate = 1.0,
   authorizedJobs = { ['ambulance']=0, ['sasp']=0, ['police']=0 },
    doorType = 'double',
    doors = {
...
-- wardbe created by don
Config.DoorList['pillbox-wardbe'] = {
    doorRate = 1.0,
   authorizedJobs = { ['ambulance']=0, ['sasp']=0, ['police']=0 },
    doorType = 'double',
    doors = {
...
-- wardd created by don
Config.DoorList['pillbox-wardd'] = {
    doorRate = 1.0,
   authorizedJobs = { ['ambulance']=0, ['sasp']=0, ['police']=0 },
    doorType = 'double',
    doors = {
...
-- down1 created by don
Config.DoorList['pillbox-down1'] = {
    locked = true,
   authorizedJobs = { ['ambulance']=0, ['sasp']=0, ['police']=0 },
    doorRate = 1.0,
    doorType = 'double',
    doors = {
        {objName = -434783486, objYaw = 70.006050109863, objCoords = vec3(345.789795, -592.722717, 28.947092)},
        {objName = -1700911976, objYaw = 70.006050109863, objCoords = vec3(346.669006, -590.302673, 28.947092)}
    },
    distance = 2,
}

-- down2 created by don
Config.DoorList['pillbox-down2'] = {
    locked = true,
   authorizedJobs = { ['ambulance']=0, ['sasp']=0, ['police']=0 },
    doorRate = 1.0,
    doorType = 'double',
    doors = {
        {objName = -1700911976, objYaw = 70.006050109863, objCoords = vec3(349.860748, -581.530457, 28.947092)},
        {objName = -434783486, objYaw = 70.006050109863, objCoords = vec3(348.981842, -583.949768, 28.947092)}
    },
    distance = 2,
}