...
table.insert(Config.DoorList, {
	maxDistance = 2.5,
	authorizedJobs = { ['catcafe']=0, ['police']=8, ['bcso']=6, ['sasp']=5 },
	locked = true,
	slides = false,
	audioRemote = false,
	doors = {
...
table.insert(Config.DoorList, {
	...
	garage = false,
	lockpick = false,
	authorizedJobs = { ['catcafe']=0, ['police']=8, ['bcso']=6, ['sasp']=5, ['ambulance']=0  },
	maxDistance = 2.0,
	fixText = false,
	audioRemote = false,
...
-- fireescape created by donthelosr
Config.DoorList['catcafe-fireescape'] = {
