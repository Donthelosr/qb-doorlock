...
Config.LockedColor = 'rgb(255, 14, 14)' -- The color of the box of the popup text if Config.ChangeColor is true and the door is locked
Config.UnlockedColor = 'rgb(75, 181 ,67)' -- The color of the box of the popup text if Config.ChangeColor is true and the door is unlocked
...
Config.DoorList = {
	...
	-- Prison Door 1
	{
		...
		authorizedJobs = { 'police','sasp','bcso','prison' },
		locked = true,
		pickable = false,
		distance = 6
	},
